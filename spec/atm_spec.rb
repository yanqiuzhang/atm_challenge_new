...
describe Atm do
    ...
    it 'funds are reduced at withdraw' do
     ...
     it 'allow withdraw if account has enough balance.' do
        expected_output = { status: true, message: 'it is successful', date: Date.today, amount: 45, bills: [20, 20, 5]}
    ...
    it 'reject withdraw if card is expired' do
        ...
        expected_output = { status: false, message: 'card_expired', date: Date.today }
